...
db.insert({'_id':'2', 'name': 'plant2', 'description': 'some desc2'});
db.insert({'_id':'3', 'name': 'plant2', 'description': 'some desc2'});
db.insert({'_id':'4', 'name': 'plant2', 'description': 'some desc2'});